                                ...
                                data && data.map(item => <tr key={item._id}>
                                    <td className="px-4 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div className="inline-flex items-center gap-x-3">
                                            ...
                                            <div className="flex items-center gap-x-2">
                                                <img className="object-cover w-10 h-10 rounded-full" src={item.image} referrerPolicy="no-referrer" alt=""/>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td className="px-12 py-4 text-sm font-medium text-gray-700 whitespace-nowrap">
                                        <div className="inline-flex items-center px-3 py-1 rounded-full gap-x-2 bg-emerald-100/60 dark:bg-gray-800">
                                            ...
                                            <h2 className="text-sm font-normal text-emerald-500">{item.status}</h2>
                                        </div>
                                    </td>
                                    <td className="px-4 py-4 text-sm whitespace-nowrap">
                                        <div className="flex items-center gap-x-2">
                                            <button onClick={()=> handleAddToTeam(item)} className="px-3 cursor-pointer py-1 flex gap-x-2 items-center  text-base text-indigo-500 rounded-full dark:bg-gray-800 bg-indigo-100/60">Add To Team<IoPersonAddOutline /></button>
                                        </div>
                                    </td>
                                </tr>)
                            }
