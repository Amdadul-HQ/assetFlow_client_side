...
const BannerForHr = () => {
    return (
        <section style={{
            ...
            <h1 className='text-6xl text-gray-100 font-bold backdrop-blur-md py-10 leading-[80px] px-4 text-center'>Manage Your Company Asset <br /> By Asset<span className='text-violet-500'>Flow</span> </h1>
        </section>
    );
};
