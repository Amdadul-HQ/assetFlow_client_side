...
const LoginPage = () => {
    ...
    <div className="container flex items-center justify-center min-h-screen px-6 mx-auto">
        ...
        <h1 className="text-2xl text-center font-semibold">Asset<span className="text-violet-500">Flow</span></h1>
            <h1 className="mt-3 text-2xl font-semibold text-gray-800 capitalize text-center sm:text-3xl dark:text-white">sign In</h1>
